...
<figure class="shot">
  <img src="{{ '/github-pages/media/mechanism-1.jpg' | relative_url }}" alt="自分のPCの中のCodexがプロトタイプを作っている図">
...
<figure class="shot">
  <img src="{{ '/github-pages/media/mechanism-2.jpg' | relative_url }}" alt="プロトタイプをクラウドにアップロードしてURLを発行する図">
...
<figure class="shot">
  <img src="{{ '/github-pages/media/mechanism-3.jpg' | relative_url }}" alt="GitHubを使って、自分のPC・スマホ・他の人のPCからアクセスできるようにする全体図">
